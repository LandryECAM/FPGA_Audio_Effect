...
HD_PWD='C:/Users/17046/Documents/FPGA - Projet/ProjetAudio/ProjetAudio.runs/design_1_clk_wiz_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clk_wiz_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clk_wiz_5.tcl
